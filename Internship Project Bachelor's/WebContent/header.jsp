...
<div class="collapse navbar-collapse menu--shylock"
	...
	<ul class="nav navbar-nav menu__list">
		...
		<li class=" menu__item"><a class="menu__link"
			href="electronics.jsp"> Accessories </a></li>
		...
		%>
	   <li class=" menu__item"><a class="menu__link" href="help.jsp">Terms&nbsp;<span class="glyphicon glyphicon-question-sign"></span></a></li>
	</ul>
</div>
